...
# Programm by Yoatn
#
# Start date   27.11.2017   21:50
# End date     00.00.2017   22:00
#  
# Description:
...
# от одного аргумента y, которая будет возвращать True, если остаток от деления y на x равен mod, и False иначе.
#
