...
# Programm by Yoatn
#
# Start date   11.11.2017   21:11
# End date     12.11.2017   00:20
#  
# Description:
...
# посредством метода append в лог отправлялось сообщение, состоящее
# из только что добавленного элемента.
#
# Примечание
# Ваша программа не должна содержать класс Loggable. При проверке
# вашей программе будет доступен этот класс, и он будет содержать
# метод log﻿, описанный выше.
# --------------------------------------------------
...
class LoggableList(list, Loggable):
    def append(self, a):
        ...
        return super(LoggableList, self).log(a)
